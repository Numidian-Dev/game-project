...
const TheGame = () => {
    return (
        <section id='the-game'>
            <div className="title-page">About the game</div>
            <div className="container-theGame">
                <div className="contents-game">
                    <div className="content-img">
                        <img src="/assets/theGame/3.jfif" alt="" />
                    </div>
                    <div className="content-p">
                        <h1>Content title</h1>
                        <p>Lorem ipsum dolor sit amet. Et incidunt sequi aut adipisci enim sed quia
                ...
                <div className="contents-game">
                    <div className="content-img">
                        <img src="/assets/theGame/2.jfif" alt="" />
                    </div>
                    <div className="content-p">
                        <h1>Content title</h1>
                        <p>Lorem ipsum dolor sit amet. Et incidunt sequi aut adipisci enim sed quia
                ...
                <div className="contents-game">
                    <div className="content-img">
                        <img src="/assets/theGame/1.jfif" alt="" />
                    </div>
                    <div className="content-p">
                        <h1>Content title</h1>
                        <p>Lorem ipsum dolor sit amet. Et incidunt sequi aut adipisci enim sed quia
